...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    public void attemptLogin() {
        ...
        if (TextUtils.isEmpty(LoginName)) {
            ...
            cancel = true;
        } else if (!isLoginlValid(LoginName)) {
        ...
        if (cancel) {
            ...
            String text = makeJsonObjectRequest(LoginName,password);
            if (text != "Acceso Denegado Favor Revise sus credenciales")
            {
                showProgress(false);
            }
    ...
    private boolean isLoginlValid(String email) {
